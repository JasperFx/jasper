...
namespace Jasper.Persistence.Testing.SqlServer.Persistence
{
    public class SqlServerEnveloperPersistorTests : SqlServerBackedListenerContext
    {
        ...
        public async Task delete_a_single_outgoing_envelope()
        {
            ...
            await ThePersistence.Outgoing.StoreOutgoing(list.ToArray(), 111);

            var toDelete = list[5];

            await ThePersistence.Outgoing.DeleteOutgoing(toDelete);
        ...
        public async Task discard_and_reassign_outgoing()
        {
            ...
            await ThePersistence.Outgoing.DiscardAndReassignOutgoing(toDiscard, toReassign, 444);
        ...
        public async Task get_counts()
        {
            ...
            await ThePersistence.Outgoing.StoreOutgoing(list.ToArray(), 0);
        ...
        public async Task store_a_single_outgoing_envelope()
        {
            ...
            await ThePersistence.Outgoing.StoreOutgoing(envelope, 5890);
