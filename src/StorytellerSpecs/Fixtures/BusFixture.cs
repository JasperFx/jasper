...
namespace StorytellerSpecs.Fixtures
{
    public abstract class BusFixture : Fixture
    {
        ...
        public static Uri LQChannel1 = new Uri("durable://localhost:2201/one");
        public static Uri LQChannel2 = new Uri("durable://localhost:2201/two");
        public static Uri LQChannel3 = new Uri("durable://localhost:2201/three");
        public static Uri LQChannel4 = new Uri("durable://localhost:2201/four");

        public static Uri InMemoryChannel1 = new Uri("local://one");
        public static Uri InMemoryChannel2 = new Uri("local://two");
        public static Uri InMemoryChannel3 = new Uri("local://three");
        public static Uri InMemoryChannel4 = new Uri("local://four");
        ...
        protected BusFixture()
        {
            ...
            AddSelectionValues("Channels", "stub://one", "stub://two", "stub://three", "stub://four", "stub://replies",
                ...
                InMemoryChannel1.ToString(), InMemoryChannel2.ToString(), InMemoryChannel3.ToString(),
                InMemoryChannel4.ToString(),
                "tcp://localhost:2201/one", "tcp://localhost:2201/two", "tcp://localhost:2201/three",
