...
namespace JasperBus.Runtime
{
    public static class DictionaryExtensions
    {
        ...
        public static void Set(this Dictionary<string, string> dict, string key, object value)
        {
        ...
        public static Uri GetUri(this Dictionary<string, string> dict, string key)
        {
