...
{
    internal static class GenericEnumerableExtensions
    {
        /// <summary>
        ...
        internal static void Fill<T>(this IList<T> list, T value)
        {
        ...
        internal static void Fill<T>(this IList<T> list, IEnumerable<T> values)
        {
        ...
        internal static void RemoveAll<T>(this IList<T> list, Func<T, bool> whereEvaluator)
        {
        ...
        /// <returns></returns>
        internal static string Join(this string[] values, string separator)
        {
        ...
        /// <returns></returns>
        internal static IEnumerable<T> Each<T>(this IEnumerable<T> values, Action<T, int> eachAction)
        {
            int index = 0;
        ...
        [DebuggerStepThrough]
        internal static IEnumerable<T> Each<T>(this IEnumerable<T> values, Action<T> eachAction)
        {
            foreach (T item in values)
            {
                eachAction(item);
        ...
        [DebuggerStepThrough]
        internal static IEnumerable Each(this IEnumerable values, Action<object> eachAction)
        {
        ...
        /// <returns></returns>
        internal static TReturn FirstValue<TItem, TReturn>(this IEnumerable<TItem> enumerable, Func<TItem, TReturn> func)
            where TReturn : class
        {
        ...
        /// <returns></returns>
        internal static IList<T> AddMany<T>(this IList<T> list, params T[] items)
        {
        ...
        /// <returns></returns>
        internal static IList<T> AddRange<T>(this IList<T> list, IEnumerable<T> items)
        {
            items.Each(list.Add);
            return list;
        }

        internal static IEnumerable<T> UnionWith<T>(this IEnumerable<T> first, params T[] second)
        {
            return first.Union(second);
        }

        // Stolen directly from Marten
        internal static IEnumerable<T> TopologicalSort<T>(this IEnumerable<T> source, Func<T, IEnumerable<T>> dependencies, bool throwOnCycle = true)
        {
