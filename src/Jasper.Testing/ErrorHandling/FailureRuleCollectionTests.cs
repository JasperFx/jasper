...
namespace Jasper.Testing.ErrorHandling
{
    ...
    {
        private readonly HandlerGraph theHandlers = new HandlerGraph();
        ...
        public void match_on_inner_exception()
        {
            ...
            theHandlers.Failures.DetermineExecutionContinuation(new Exception("bad", new DivideByZeroException()), theEnvelope)
                .ShouldBeOfType<DiscardEnvelope>();

            theHandlers.Failures.DetermineExecutionContinuation(new Exception("worse", new BadImageFormatException()), theEnvelope)
                .ShouldBeOfType<RequeueContinuation>();
        }
        ...
        public void match_on_inner_exception_and_predicate()
        {
            ...
            theHandlers.Failures.DetermineExecutionContinuation(new Exception("bad", new CodeException(){Code = 1}), theEnvelope)
                .ShouldBeOfType<DiscardEnvelope>();

            theHandlers.Failures.DetermineExecutionContinuation(new Exception("worse", new CodeException{Code = 2}), theEnvelope)
                .ShouldBeOfType<RequeueContinuation>();
        }
        ...
        public void and_message_contains_match()
        {
            ...
            theHandlers.Failures.DetermineExecutionContinuation(new DivideByZeroException("big boom in the room"), theEnvelope)
                .ShouldBeOfType<DiscardEnvelope>();
