...
internal class NoHandlerExecutor : IExecutor
{
    ...
    public Task<IContinuation> ExecuteAsync(IExecutionContext context, CancellationToken cancellation)
    {
        return Task.FromResult(_continuation);
    }

    public Task<InvokeResult> InvokeAsync(IExecutionContext context, CancellationToken cancellation)
    {
