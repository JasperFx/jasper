...
public class StaticRoute : IMessageRoute
{
        ...
        MessageTypeRouting routing)
    {
        ...
        _writer = _endpoint.DefaultSerializer ??
                  throw new InvalidOperationException(
                      $"The endpoint at '{_endpoint.Uri}' does not have any known serializers");
    }
    ...
    private void applyEnvelopeRules(Envelope envelope)
    {
        ...
        foreach (var customization in _routing.Customizations) customization(envelope);
    }
}
