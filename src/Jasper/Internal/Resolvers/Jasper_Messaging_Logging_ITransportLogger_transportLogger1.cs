...
namespace Jasper.Internal.Resolvers
{
    ...
    {
        private readonly Microsoft.Extensions.Logging.ILoggerFactory _loggerFactory1396120497;
        private readonly Lamar.IoC.Scope _topLevelScope;

        public Jasper_Messaging_Logging_ITransportLogger_transportLogger1([Lamar.Named("loggerFactory2")] Microsoft.Extensions.Logging.ILoggerFactory loggerFactory1396120497, Lamar.IoC.Scope topLevelScope) : base(topLevelScope)
        {
            _loggerFactory1396120497 = loggerFactory1396120497;
        ...
        public override Jasper.Messaging.Logging.ITransportLogger Build(Lamar.IoC.Scope scope)
        {
            ...
            return new Jasper.Messaging.Logging.TransportLogger(_loggerFactory1396120497, nulloMetrics);
        }
