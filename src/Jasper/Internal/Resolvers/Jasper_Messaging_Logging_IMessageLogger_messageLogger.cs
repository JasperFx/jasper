...
namespace Jasper.Internal.Resolvers
{
    ...
    public class Jasper_Messaging_Logging_IMessageLogger_messageLogger : Lamar.IoC.Resolvers.SingletonResolver<Jasper.Messaging.Logging.IMessageLogger>
    {
        ...
        public Jasper_Messaging_Logging_IMessageLogger_messageLogger([Lamar.Named("loggerFactory2")] Microsoft.Extensions.Logging.ILoggerFactory loggerFactory_415413167, Lamar.IoC.Scope topLevelScope) : base(topLevelScope)
        {
        ...
        public override Jasper.Messaging.Logging.IMessageLogger Build(Lamar.IoC.Scope scope)
        {
            ...
            return new Jasper.Messaging.Logging.MessageLogger(_loggerFactory_415413167, nulloMetrics);
        }
