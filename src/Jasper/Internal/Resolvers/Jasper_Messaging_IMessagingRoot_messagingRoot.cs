...
namespace Jasper.Internal.Resolvers
{
    ...
    public class Jasper_Messaging_IMessagingRoot_messagingRoot : Lamar.IoC.Resolvers.SingletonResolver<Jasper.Messaging.IMessagingRoot>
    {
        ...
        private readonly Jasper.Messaging.Logging.ITransportLogger _transportLogger_308692646;
        ...
        public Jasper_Messaging_IMessagingRoot_messagingRoot(Jasper.Messaging.Runtime.Serializers.MessagingSerializationGraph messagingSerializationGraph, Jasper.Messaging.Transports.Configuration.MessagingSettings messagingSettings, Jasper.Messaging.Model.HandlerGraph handlerGraph, [Lamar.Named("transportLogger2")] Jasper.Messaging.Logging.ITransportLogger transportLogger_308692646, Jasper.Messaging.IChannelGraph channelGraph, Jasper.Messaging.Runtime.Subscriptions.ISubscriptionsRepository subscriptionsRepository, Jasper.Messaging.Logging.IMessageLogger messageLogger, Lamar.IoC.Scope topLevelScope) : base(topLevelScope)
        {
            _messagingSerializationGraph = messagingSerializationGraph;
            _messagingSettings = messagingSettings;
            _handlerGraph = handlerGraph;
            _transportLogger_308692646 = transportLogger_308692646;
        ...
        public override Jasper.Messaging.IMessagingRoot Build(Lamar.IoC.Scope scope)
        {
            ...
            var nulloDurableMessagingFactory = new Jasper.Messaging.Transports.NulloDurableMessagingFactory(_transportLogger_308692646, _messagingSettings);
            return new Jasper.Messaging.MessagingRoot(_messagingSerializationGraph, _messagingSettings, _handlerGraph, nulloDurableMessagingFactory, _channelGraph, _subscriptionsRepository, _messageLogger, container, _transportLogger_308692646);
        }
