...
namespace Jasper.ErrorHandling
{
    ...
    public class ContinuationFactory : IContinuationFactory
    {
        ...
        {
            _sources.Add((env, ex) => RetryNowContinuation.Instance);
        }
        ...
        public void Requeue()
        {
            _sources.Add((env, ex) => RequeueContinuation.Instance);
        }
        ...
        {
            _sources.Add((env, ex) => new ScheduledRetryContinuation(delay));
        }
        ...
        {
            _sources.Add((env, ex) => new MoveToErrorQueue(ex));
        }
        ...
        public void Discard()
        {
            _sources.Add((env, ex) => DiscardExpiredEnvelope.Instance);
        }
    }
}
