...
using Baseline;
using DurabilitySpecs.Fixtures.SqlServer.App;
using Jasper;
...
namespace DurabilitySpecs.Fixtures.SqlServer
{
    public class SqlServerBackedPersistenceFixture : Fixture
    {
        ...
        public override void SetUp()
        {
            ...
            new SchemaLoader(ConnectionSource.ConnectionString, "receiver").RecreateAll();
            new SchemaLoader(ConnectionSource.ConnectionString, "sender").RecreateAll();
