...
{
    public static class PulsarTransportConfigurationExtensions
    {/// <summary>
        ...
        public static void ConfigurePulsar(this IEndpoints endpoints, Action<PulsarTransport> configure)
        {
        ...
        /// <returns></returns>
        public static PulsarListenerConfiguration ListenToPulsarTopic(this IEndpoints endpoints, string subscription, string topicName) =>
            ListenToPulsarTopic(endpoints, new ConsumerOptions(subscription, topicName));
        
        public static PulsarListenerConfiguration ListenToPulsarTopic(this IEndpoints endpoints, ConsumerOptions consumerConfig)
        {
        ...
        /// <returns></returns>
        public static PulsarSubscriberConfiguration ToPulsarTopic(this IPublishToExpression publishing, string topicName) => ToPulsarTopic(publishing, new ProducerOptions(topicName));

        public static PulsarSubscriberConfiguration ToPulsarTopic(this IPublishToExpression publishing, ProducerOptions producerOptions)
        {
